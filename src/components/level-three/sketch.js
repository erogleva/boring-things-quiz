...
export default function sketch(p) {
    ...
    p.setup = () => {
        ...
        calculator = new picture(imgPosX, imgPosY, machinePic, p);
        ...
        button1 = new button(57, buttonPic, buttonSound, null, 100000, p);
        button2 = new button(57, buttonPic, buttonSound, 0, 10000, p);
        button3 = new button(57, buttonPic, buttonSound, 1, 1000, p);
        button4 = new button(57, buttonPic, buttonSound, 2, 100, p);
        button5 = new button(57, buttonPic, buttonSound, 3, 10, p);
        button6 = new button(57, buttonPic, buttonSound, 4, 1, p);

        // Create button array
        buttonArray.push(button1, button2, button3, button4, button5, button6);

        // Construct display classes
        display1 = new display(50, 28, 10, p); // round edge does not work
        display2 = new display(50, 28, 10, p);
        display3 = new display(50, 28, 10, p);
        display4 = new display(50, 28, 10, p);
        display5 = new display(50, 28, 10, p);
        display6 = new display(50, 28, 10, p);
        ...
        // number pluss number
        ibutton1 = new infoButton(250, 20, p);
        // points
        ibutton2 = new infoButton(250, 10, p);
        // reset button
        ibutton3 = new infoButton(250, 20, p);
        // done button
        ibutton4 = new infoButton(250, 20, p);
    };
    ...
    p.draw = () => {
        ...
        displayArray.forEach(function (displayElement, i) {
            displayElement.show(calculator.getButtonX(i), calculator.getButtonY() - 58, p.str(buttonArray[i].getPosition()));
        });
