...
const CalculatorHelp = (props: Props) => {
  return <React.Fragment>
      ...
      <Trans render="h6">Fange an, indem du die erste Zahl in die Rechenmaschine eingibst. Dazu klickst du die Scheiben unter den bunten Nullen. Die farbigen Felder von links nach rechts stehen für Einser, Zehner, Hunderter usw. Daher musst du immer von links nach rechts arbeiten.</Trans>
      <Trans render="h6">Wenn die Aufgabe 23 + 45 ist, gibst du erst die Drei ein, indem du drei mal auf die erste Scheibe von Links drei klickst, dann gehst du eine Scheibe nach rechts und klickst zwei mal. </Trans>
